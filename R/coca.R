...
#'
#'   \item{nam.dat}{list with components `namY` and
#'     `namX` containing the names of the response and the
#'     predictor(s) respectively.}
#'
#'   \item{call}{the matched call.}
#'
#'   \item{method}{the CoCA method used, one of `"predictive"`
#'     or `"symmetric"`.}
#'
...
#'
#'   \item{totalVar}{list with components `Yblock` and
...
#'     only).}
#'
#'   \item{inertia}{list with components `total` and
