...
#'     for.
#' @param object an object of class `coinertia`.
#' @param axes the number of axes to display when printing.
#' @param digits the number of significant digits to use in printing
#' @param \ldots arguments passed to other functions. Currently ignored.
#' @returns A list with the following components:
#'   \item{U1 }{column weights of `X`.}
#'   \item{U2 }{column weights of `Y`.}
#'   \item{X1 }{rowscores of `X`.}
#'   \item{X2 }{rowscores of `Y`.}
