...
#' @param object an object of class `"predcoca"` or
...
#'   \item{totalVar}{a list with components `Yblock` and `Xblock`
#'     containing the total variance in the response and the predictor data
#'     sets respectively}
#'   \item{inertia}{a list with components `total` and `residual`
