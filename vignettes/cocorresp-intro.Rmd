...
%\VignetteIndexEntry{Introduction to cocorresp}
-->
...
A screeplot provides a compact summary of the dimensionality of the covariance between the two matrices.
